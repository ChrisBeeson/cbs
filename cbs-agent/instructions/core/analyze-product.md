...
<instructions>
  ...
  ALLOW: plan-product.md to create cbs-agent/product/ structure
</instructions>
...
<verification_checklist>
  - [ ] cbs-agent/product/ directory created
...
<summary_template>
  ...
  - ✓ Product documentation in `cbs-agent/product/`
  - ✓ Roadmap with completed work in Phase 0
  - ✓ Tech stack reflecting actual dependencies

  ### Next Steps

  1. Review the generated documentation in `cbs-agent/product/`
